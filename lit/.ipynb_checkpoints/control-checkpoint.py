...
def per_layer_loss(args, decoder_model, tokenizer, **kwargs):
    ...
    # per_layer_loss builds and passes a 4D causal mask.
    # FlashAttention2 does not support this reliably, so force eager attention.
    for m in [target_model, decoder_model]:
    ...
    for i in tqdm(range(len(dataset) // args.batch_size)):
        ...
        if hasattr(target_model.model.model, "_update_causal_mask"):
            ...
            # Older/newer transformers may not expose _update_causal_mask on LlamaModel.
            try:
            ...
            try:
                causal_mask = _prepare_4d_causal_attention_mask(
                    ...
                    input_shape=tokenized_read.input_ids.shape,
                ...
                causal_mask = _prepare_4d_causal_attention_mask(
                    tokenized_read.attention_mask,
                    tokenized_read.input_ids.shape,
                    inputs_embeds,
                    0,
                )
